...
<body>
	...
	<form:form modelAttribute="instructor" class="form-horizontal" method="POST" enctype="utf8">
	<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
				<form:input  class="form:input-large"  id="street" path="address.country" value="" type="text" />
				...
				<div class="col-lg-10">
				<form:input  class="form:input-large"  id="state" path="address.state" value="" type="text" />
            ...
            <div class="form-group">
				...
				<form:input  class="form:input-large" id="zipcode" path="address.zipcode" value="" type="text" />
		           ...
		           <form:hidden path="user.authority"
						value="student" /> <%-- <form:errors path="credentials.authority[0].authority" cssClass="text-danger"/> --%>		
			...
			<label class="control-label col-lg-2" for="username">User Name:</label>
				<div class="col-lg-10">	
				<form:input class="form:input-large" id ="username" path="user.username" value="" />
              ...
              <div class="form-group">
				...
				<div class="col-lg-10">	
				<form:input class="form:input-large" id= "password" path="user.password" value=""
