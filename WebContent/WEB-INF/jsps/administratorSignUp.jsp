...
<body>
	...
	<div id="main">
		<section class="container"> <form:form
			modelAttribute="administrator" class="form-horizontal" method="POST"
			enctype="utf8">
			<fieldset>
                ...
                <div class="form-group">
					...
					<div class="col-sm-10">
						<form:input class="form:input-large" id="position"
							path="position" value="" />
				...
				<form:hidden path="user.authority.authority" value="ROLE_ADMIN" />
